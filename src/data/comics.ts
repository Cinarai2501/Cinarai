...
export const COMICS: Comic[] = [
  ...
  // Sumber: public/comics/komik-4/comic.pdf
  {
    ...
    characters: [
      {
        name: 'Aisyah',
        description: 'Siswi yang teliti mengamati hasil pengukuran dan data kendaraan.',
        avatar: '/assets/dashboard/home/avatars/avatar-anak-perempuan.png',
      },
      {
        name: 'Hilya',
        description: 'Siswi yang ikut mengukur panjang lintasan Jembatan Merah.',
        avatar: '/assets/dashboard/home/avatars/avatar-anak-perempuan.png',
      },
      {
        name: 'Hanan',
        description: 'Siswa yang mengukur lintasan dengan langkah kaki.',
        avatar: '/assets/dashboard/home/avatars/avatar-anak-laki-laki.png',
      },
    ],
    learningTargets: [
      'Mengukur panjang lintasan Jembatan Merah menggunakan langkah kaki',
      'Menghubungkan jumlah langkah dengan panjang setiap langkah',
      'Mengumpulkan, menyajikan, membaca, dan membandingkan data hasil pengukuran',
      'Menganalisis data kendaraan yang melewati Jembatan Merah',
    ],
    estimatedMinutes: 30,
