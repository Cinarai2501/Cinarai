  ...
  learningObjects: [
    {
      ...
      modelUrl: 'https://sketchfab.com/3d-models/candi-jawi-with-precision-geometry-83da3450467747fda7872c5a9392ffac',
      embedUrl: 'https://sketchfab.com/3d-models/candi-jawi-with-precision-geometry-83da3450467747fda7872c5a9392ffac',
      viewerType: 'embed',
      provider: 'Sketchfab',
    ...
    },
    {
      ...
      modelUrl: 'https://asblr.com/KjCtQB',
      embedUrl: 'https://asblr.com/KjCtQB',
      viewerType: 'url',
      provider: 'Assemblr',
    ...
    },
    {
      ...
      modelUrl: 'https://asblr.com/pxMwEe',
      embedUrl: 'https://asblr.com/pxMwEe',
      viewerType: 'url',
      provider: 'Assemblr',
    ...
    },
    {
      ...
      modelUrl: 'https://asblr.com/3oXoRI',
      embedUrl: 'https://asblr.com/3oXoRI',
      viewerType: 'url',
      provider: 'Assemblr',
    ...
    },
    {
      ...
      objectImage: '/images/identification/komik1-soal4.jpg',
      modelUrl: 'https://asblr.com/G3F41T',
      embedUrl: 'https://asblr.com/G3F41T',
      viewerType: 'url',
      provider: 'Assemblr',
    ...
    questions: [
      {
        ...
        photoSrc: '/images/argumentation/komik1-tubuh.svg',
        photoAlt: 'Ilustrasi bagian tubuh Candi Jawi yang menonjolkan bentuk kubus.',
        shapeName: 'Kubus',
        shapeKey: 'kubus',
      ...
      },
      {
        ...
        question: 'Mengapa bagian atap Candi Jawi dapat dianggap sebagai kerucut?',
        photoSrc: '/images/argumentation/komik1-atap.svg',
        photoAlt: 'Ilustrasi bagian atap Candi Jawi yang menonjolkan bentuk meruncing.',
        shapeName: 'Kerucut',
        shapeKey: 'kerucut',
      ...
      {
        id: 'komik1-arg-3',
        templePart: 'Bagian Pintu',
        question: 'Mengapa bagian pintu Candi Jawi dapat dipandang sebagai balok?',
        photoSrc: '/images/argumentation/komik1-pintu.svg',
        photoAlt: 'Ilustrasi bagian pintu Candi Jawi yang menonjolkan bentuk balok.',
        shapeName: 'Balok',
        shapeKey: 'balok',
      ...
      {
        id: 'komik1-arg-4',
        templePart: 'Bagian Tangga',
        question: 'Mengapa bagian tangga Candi Jawi dapat dipahami sebagai prisma segi empat?',
        photoSrc: '/images/argumentation/komik1-tangga.svg',
        photoAlt: 'Ilustrasi bagian tangga Candi Jawi yang menonjolkan bentuk prisma.',
