  ...
  learningObjects: [
    {
      ...
      displayName: 'Umpang',
      title: 'Umpang',
      description: 'Umpang merupakan bagian dasar bangunan candi yang berbentuk persegi panjang. Dari bagian ini kita dapat mengenali sisi yang berhadapan sama panjang serta sudut-sudut siku-siku yang membentuk persegi panjang.',
      page: 1,
    ...
    },
    {
      ...
      title: 'Balai Agung',
      description: 'Balai Agung memiliki denah berbentuk persegi panjang. Bentuk ini membantu kita memahami panjang, lebar, dan susunan bangunan yang tampak teratur serta simetris.',
      page: 2,
    ...
    },
    {
      ...
      title: 'Candi Angka',
      description: 'Bagian atap Candi Angka membentuk siluet menyerupai segitiga. Dari bentuk ini kita dapat mengamati sisi-sisi yang bertemu pada satu titik puncak.',
      page: 3,
    ...
    },
    {
      ...
      title: 'Candi Induk',
      description: 'Bagian depan Candi Induk memperlihatkan bidang-bidang persegi panjang pada tubuh bangunan. Bentuk tersebut menunjukkan susunan batu yang rapi dan teratur.',
      page: 4,
    ...
    },
    {
      ...
      displayName: 'Pendopo',
      title: 'Pendopo',
      description: 'Area Pendopo memiliki bentuk dasar persegi panjang yang luas. Bentuk ini memudahkan kita mengenali sisi yang sejajar dan sudut siku-siku pada denah bangunan.',
      page: 5,
    ...
    },
    {
      ...
      title: 'Relief Candi',
      description: 'Pada relief candi terdapat hiasan berbentuk belah ketupat. Bangun datar ini memiliki empat sisi sama panjang dengan dua diagonal yang saling berpotongan.',
      page: 6,
