...
const assetSrc = (asset: { src?: string } | string): string => typeof asset === 'string' ? asset : asset.src ?? '';
...
export const packageContent: ComicContentPackageLike = {
  ...
  identification: {
    questions: [
      {
        id: 'komik2-ident-1',
        question: 'Bentuk apa yang terlihat pada motif relief persegi di Candi Penataran?',
        image: assetSrc(qrReliefCandi),
        ...
        explanation: 'Motif relief tersebut memiliki empat sisi sama panjang dan empat sudut siku-siku.',
      },
      {
        id: 'komik2-ident-2',
        question: 'Bentuk bangun datar apa yang paling terlihat pada Umpang?',
        image: assetSrc(navUmpang),
        imageAlt: 'Bagian Umpang pada Candi Penataran.',
        options: [
        ...
        explanation: 'Umpang dapat diamati sebagai bidang persegi panjang dengan sisi panjang dan sisi pendek.',
      },
      {
        id: 'komik2-ident-3',
        question: 'Bentuk apa yang terlihat pada atap Candi Angka yang runcing?',
        image: assetSrc(navAtapCandi),
        imageAlt: 'Atap Candi Angka Tahun yang tampak runcing.',
        options: [
        ...
        explanation: 'Atap Candi Angka memiliki bentuk runcing dengan dua sisi yang tampak sama panjang.',
      },
      {
        id: 'komik2-ident-4',
        question: 'Bentuk apa yang tampak pada Mensir sebagai ornamen dengan pola simetris?',
        image: assetSrc(navAtapCandi),
        imageAlt: 'Ornamen Mensir pada Candi Penataran.',
        options: [
        ...
        explanation: 'Pola ornamen Mensir dapat diamati melalui sisi dan susunan yang seimbang.',
      },
      {
        id: 'komik2-ident-5',
        question: 'Bangun datar apa yang terlihat pada relief lingkaran di Candi Penataran?',
        image: assetSrc(navReliefCandi),
        imageAlt: 'Relief lingkaran pada Candi Penataran.',
        options: [
        ...
        explanation: 'Relief lingkaran memiliki sisi lengkung dan titik-titik yang berjarak sama dari pusat.',
      },
      {
        id: 'komik2-ident-6',
        question: 'Bangun datar apa yang terlihat pada ornamen belah ketupat atau wajik di Pendopo?',
        image: assetSrc(navPendopo),
        imageAlt: 'Ornamen belah ketupat pada Pendopo Candi Penataran.',
        options: [
        ...
        explanation: 'Ornamen wajik pada Pendopo dapat dipelajari sebagai belah ketupat dengan empat sisi sama panjang.',
      },
    ],
    feedback: {
  ...
  application: {
    ...
    options: [
      ...
      { value: 'Segitiga Sama Kaki', label: 'Segitiga Sama Kaki' },
      { value: 'Segitiga Sama Sisi', label: 'Segitiga Sama Sisi' },
    ...
    missions: [
      {
        ...
        illustration: assetSrc(persegiResolutionIllustration),
      },
      {
        id: 2,
        ...
        illustration: assetSrc(persegiPanjangResolutionIllustration),
      },
      {
        id: 3,
        ...
        illustration: assetSrc(segitigaSamaKakiResolutionIllustration),
      },
      {
        id: 4,
        ...
        illustration: assetSrc(segitigaSamaSisiResolutionIllustration),
      },
      {
        id: 5,
        ...
        illustration: assetSrc(lingkaranResolutionIllustration),
      },
      {
        id: 6,
        ...
        illustration: assetSrc(belahKetupatResolutionIllustration),
      },
    ],
  },
  introspection: {
