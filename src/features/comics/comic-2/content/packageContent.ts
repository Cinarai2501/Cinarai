...
export const packageContent: ComicContentPackageLike = {
  ...
  identification: {
    questions: [
      {
        id: 'komik2-ident-1',
        question: 'Perhatikan motif relief persegi pada dinding Candi Penataran. Bangun datar mana yang paling cocok dengan motif ini?',
        image: qr13.src,
        ...
        explanation: 'Motif ini punya sisi yang sama panjang dan sudut siku-siku, jadi paling cocok disebut persegi.',
      },
      {
        id: 'komik2-ident-2',
        question: 'Pada bagian Umpang, bentuknya tampak panjang dan seimbang. Bangun datar apa yang paling sesuai dengan bentuk itu?',
        image: navUmpang.src,
        ...
        explanation: 'Umpang terlihat seperti bidang panjang dengan dua pasang sisi yang sama, jadi bentuknya adalah persegi panjang.',
      },
      {
        id: 'komik2-ident-3',
        question: 'Candi Angka punya bagian atap yang tampak runcing dan seimbang di kedua sisi. Bangun datar apa yang paling cocok?',
        image: qr17.src,
        ...
        explanation: 'Bentuk atap ini mirip segitiga sama sisi karena sisi-sisinya sama panjang dan seimbang.',
      },
      {
        id: 'komik2-ident-4',
        question: 'Pada pola Mensir, kita melihat susunan yang sama di kiri dan kanan. Bentuk apa yang paling cocok dengan pola itu?',
        image: qr13.src,
        imageAlt: 'Pola Mensir pada Candi Penataran yang terlihat berulang dan seimbang.',
        options: [
          { text: 'Persegi', correct: true },
          { text: 'Persegi Panjang', correct: false },
          { text: 'Segitiga Sama Sisi', correct: false },
        ...
        explanation: 'Pola Mensir terasa seperti susunan persegi yang rapi dan sama di kedua sisi, jadi jawabannya adalah persegi.',
      },
      {
        id: 'komik2-ident-5',
        question: 'Relief lingkaran pada ukiran Candi Penataran terlihat bundar dan tidak punya sudut. Bangun datar mana yang paling sesuai?',
        image: qr18.src,
        ...
        explanation: 'Relief ini berbentuk lingkaran karena sisi luarnya melengkung dan tidak punya sudut.',
      },
      {
        id: 'komik2-ident-6',
        question: 'Ornamen belah ketupat pada ukiran Candi Penataran tampak seperti wajik yang seimbang. Bangun datar apa yang paling sesuai?',
        image: navReliefLingkaran.src,
        imageAlt: 'Ornamen belah ketupat pada ukiran Candi Penataran.',
        options: [
          { text: 'Persegi', correct: false },
          { text: 'Persegi Panjang', correct: false },
          { text: 'Segitiga Sama Sisi', correct: false },
        ...
        explanation: 'Ornamen ini berbentuk belah ketupat, karena sisi-sisinya sama panjang dan bentuknya seperti wajik.',
      },
    ],
    feedback: {
