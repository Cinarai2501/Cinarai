...
export default function NoteArea({ itemId, value, isSaved, onChange }: NoteAreaProps) {
  return (
    <div className="flex flex-col gap-2">
      <label
        htmlFor={`note-${itemId}`}
        className="flex items-center gap-2 text-base font-black text-neutral-700"
      >
      ...
      <textarea
        ...
        rows={4}
        className={[
          'w-full min-h-[150px] resize-none rounded-2xl border-2 px-5 py-4 text-base leading-relaxed outline-none transition-colors',
          isSaved
