  ...
  return (
    <div className="mx-auto max-w-[1200px] bg-[#F5F8FD] px-3 pb-28 sm:px-6 lg:px-8 space-y-4">
      ...
      >
        <div className="relative z-10 flex items-start justify-between gap-4">
          ...
          <div className="relative flex-shrink-0">
            <div className="flex h-[92px] w-[92px] items-center justify-center rounded-full bg-white/20 p-1 ring-4 ring-white/30 shadow-md">
              <Image
                src={avatarAsset}
            ...
            <button
              ...
              className="absolute -bottom-1 -right-1 flex h-[32px] w-[32px] items-center justify-center rounded-full bg-white text-[#0F766E] shadow-md transition hover:scale-110 active:scale-95"
        ...
        <div className="rounded-3xl bg-white p-2 shadow-[0_10px_30px_rgba(15,23,42,0.06)] border border-slate-100 divide-y divide-slate-100">
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#CCFBF1] text-[#0D9488]">
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#DBEAFE] text-[#2563EB]">
                <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#F3E8FF] text-[#9333EA]">
                <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#FFEDD5] text-[#EA580C]">
                <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#DCFCE7] text-[#16A34A]">
                <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
          ...
          >
            <div className="flex items-center gap-3.5 min-w-0">
              <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#E0F2FE] text-[#0284C7]">
                <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <circle cx="12" cy="12" r="10" />
      ...
      <div className="rounded-3xl bg-white p-2 shadow-[0_10px_30px_rgba(15,23,42,0.06)] border border-slate-100">
        ...
        >
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="flex h-[50px] w-[50px] shrink-0 items-center justify-center rounded-2xl bg-[#FEE2E2] text-[#EF4444]">
              <svg viewBox="0 0 24 24" className="h-[24px] w-[24px]" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
