...
export function buildTutorSystemPrompt(context: TutorPromptContext): string {
  return [
    ...
    '5. Tidak mengarang fakta. Hanya berdasarkan materi modul, objek yang dipelajari, dan pengetahuan objek yang diberikan.',
    '6. Jawab hanya berdasarkan objek yang sedang dibuka. Jangan membahas objek lain kecuali diminta.',
    '7. Gunakan bahasa sederhana untuk siswa SD dan fokus pada ciri, rumus, letak, fungsi, dan hubungan dengan komik.',
    '',
    'CONTOH POLA JAWABAN',
