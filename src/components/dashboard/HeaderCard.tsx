...
export default function HeaderCard({
  ...
  return (
    <section
      className={`relative flex min-h-[144px] w-full items-center justify-between overflow-hidden rounded-b-[32px] px-5 py-5 pb-14 text-white shadow-[0_10px_30px_rgba(0,0,0,0.12)] sm:px-6 ${className}`}
      style={{
