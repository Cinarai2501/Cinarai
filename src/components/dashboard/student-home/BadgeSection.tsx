    ...
    <section className="rounded-2xl bg-white p-4 shadow-[0_8px_24px_rgba(0,0,0,0.06)] border border-slate-100 space-y-3">
      ...
      <div className="flex items-center justify-between gap-2 overflow-x-auto pb-1 no-scrollbar pt-1">
        {badgeItems.map((badge) => (
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-50 p-1.5 shadow-sm border border-slate-100 transition-transform hover:scale-105">
              <Image
                src={badge.asset}
                alt={badge.title}
                width={48}
