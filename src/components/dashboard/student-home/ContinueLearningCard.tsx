  ...
  return (
    <section className="relative overflow-hidden rounded-[26px] bg-white p-[14px] shadow-[0_12px_24px_rgba(15,23,42,0.10)]" style={{ maxHeight: 110, minHeight: 110 }}>
      <div className="flex h-full items-center gap-[12px]">
        <div className="h-[82px] w-[62px] shrink-0 overflow-hidden rounded-[18px] bg-slate-100 shadow-[0_8px_18px_rgba(15,23,42,0.08)]">
          <Image src={coverAsset} alt={title} width={62} height={82} className="h-full w-full object-cover" />
        </div>
      ...
      <Link href="/dashboard/siswa/komik" className="absolute right-[12px] bottom-[12px] flex h-[40px] w-[40px] items-center justify-center rounded-full bg-[#1D93FF] shadow-[0_12px_22px_rgba(29,147,255,0.22)]" aria-label="Lanjutkan belajar">
        <svg viewBox="0 0 24 24" className="h-[15px] w-[15px]" fill="none" stroke="white" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M5 12h14" />
