...
export default function ContinueLearningCard({ coverAsset, title, progressPct }: ContinueLearningCardProps) {
  return (
    <section className="rounded-[28px] bg-[#F6F9FE] p-[16px] shadow-[0_10px_24px_rgba(15,23,42,0.05)]" style={{ minHeight: 176 }}>
      <div className="flex h-full items-center gap-[14px]">
        <div className="h-[108px] w-[90px] shrink-0 overflow-hidden rounded-[20px] bg-slate-100">
          <Image src={coverAsset} alt={title} width={90} height={108} className="h-full w-full object-cover" />
        </div>
