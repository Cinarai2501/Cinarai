...
export default function StatisticsGrid({ statCards }: StatisticsGridProps) {
  return (
    <section className="rounded-[28px] bg-[#F8FAFF] p-[18px] shadow-[0_10px_24px_rgba(15,23,42,0.08)]">
      <div className="grid grid-cols-2 gap-[14px]">
        {statCards.map((stat) => (
          <div key={stat.label} className="flex min-h-[116px] items-center gap-[14px] rounded-[24px] bg-white px-[16px] py-[16px] shadow-sm">
            <div className="flex h-[56px] w-[56px] shrink-0 items-center justify-center rounded-full bg-white shadow-[0_8px_20px_rgba(15,23,42,0.08)]" style={{ background: stat.bg }}>
