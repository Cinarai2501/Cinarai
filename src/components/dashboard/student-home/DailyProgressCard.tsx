...
export default function DailyProgressCard({ progressPct, stageLabel, nextStageLabel }: DailyProgressCardProps) {
  return (
    <section className="rounded-[28px] bg-[#FEFCFF] p-[16px] shadow-[0_10px_24px_rgba(15,23,42,0.08)]" style={{ minHeight: 164 }}>
      <div className="flex items-center justify-between gap-[12px]">
        <div className="flex items-center gap-[10px]">
          ...
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[#9CA3AF]">Progress Belajar Hari Ini</p>
          </div>
        </div>
      ...
      <div className="mt-[10px] flex items-end justify-between gap-[12px]">
        <div>
          <p className="text-[13px] font-medium text-[#475569]">Kamu sudah menyelesaikan</p>
          <p className="mt-[4px] text-[28px] font-black text-[#111827]">{progressPct}%</p>
          <p className="mt-[4px] text-[11px] font-semibold uppercase tracking-[0.18em] text-[#6B7280]">{stageLabel}</p>
        </div>
        <div className="text-right">
          <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#6B7280]">Tahap berikutnya</p>
          <p className="mt-[4px] text-[13px] font-semibold text-[#111827]">{nextStageLabel}</p>
        </div>
      </div>
